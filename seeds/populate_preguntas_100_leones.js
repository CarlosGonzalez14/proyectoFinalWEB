exports.seed = async function (knex) {
    ...
    const respuestas = [
      { id_pregunta: idPreguntaValues[0], respuesta: 'Windows', puntaje: 73 },
      { id_pregunta: idPreguntaValues[0], respuesta: 'OS X (Apple)', puntaje: 20 },
      { id_pregunta: idPreguntaValues[0], respuesta: 'Linux', puntaje: 5 },
      { id_pregunta: idPreguntaValues[0], respuesta: 'ChromeOS', puntaje: 2 },
      ...
      { id_pregunta: idPreguntaValues[2], respuesta: 'JavaScript', puntaje: 29 },
      { id_pregunta: idPreguntaValues[2], respuesta: 'Python', puntaje: 19 },
      { id_pregunta: idPreguntaValues[2], respuesta: 'Java', puntaje: 17 },
      { id_pregunta: idPreguntaValues[2], respuesta: 'C#', puntaje: 11 },
      { id_pregunta: idPreguntaValues[2], respuesta: 'PHP', puntaje: 9 },
      { id_pregunta: idPreguntaValues[2], respuesta: 'C/C++', puntaje: 9 },
      { id_pregunta: idPreguntaValues[2], respuesta: 'Ruby', puntaje: 4 },
      { id_pregunta: idPreguntaValues[2], respuesta: 'Go', puntaje: 2 },
    ];
